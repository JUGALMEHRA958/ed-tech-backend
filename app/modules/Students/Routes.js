...
module.exports = (app, express) => {
    ...
    router.post('/students/register', Validators.userSignupValidator(), Validators.validate, (req, res, next) => {
    ...
    router.post('/students/resetPassword', Validators.resetPasswordValidator(), Validators.validate, (req, res, next) => {
        const userObj = (new StudentsController()).boot(req, res);
    ...
    router.get('/students/verifyUser', Validators.verifyUserValidator(), Validators.validate, (req, res, next) => {
        const userObj = (new StudentsController()).boot(req, res);
