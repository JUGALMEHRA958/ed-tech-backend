    ...
    static createDiscountGroupValidator() {
        try {
            return [
                ...
                check('isValidForAll').exists().isNumeric().withMessage(i18n.__("%s REQUIRED", 'isValidForAll')),
                check('courseId').exists().isNumeric().withMessage(i18n.__("%s REQUIRED", 'courseId')),
