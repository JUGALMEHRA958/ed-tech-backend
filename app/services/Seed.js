    ...
    async addEmailTemplate() {
        try {
            ...
            let registerMail = {
                ...
                'emailContent': "<p><span style=\"color: rgb(0,0,0);font-size: 13px;font-family: Arial;\">Hello {{{fullName}}}, <br> Thank you for registering. We hope our official Cambridge preparation material helps you reach your desired IELTS band score.<br>Happy learning!  <br>Cambridge University Press & Assessment</p>"
            };
